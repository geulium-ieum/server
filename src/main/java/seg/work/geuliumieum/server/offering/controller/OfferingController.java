...
public class OfferingController {
    ...
    public ResponseEntity<Slice<OfferingResponse>> list(UserInfo user, @PathVariable("id") Long memorialId, @ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<OfferingResponse> create(UserInfo user, @PathVariable("id") Long memorialId, @Valid @RequestBody OfferingRequest request) {
