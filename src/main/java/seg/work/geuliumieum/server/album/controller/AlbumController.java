...
public class AlbumController {
    ...
    public ResponseEntity<Slice<AlbumResponse>> listAlbums(UserInfo user, @PathVariable("id") Long memorialId, @ParameterObject Pageable pageable) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AlbumResponse> getAlbum(UserInfo user, @PathVariable("id") Long albumId) {
    ...
    public ResponseEntity<AlbumResponse> createAlbum(UserInfo user, @PathVariable("id") Long memorialId, @Valid @RequestBody AlbumCreateRequest request) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateAlbum(UserInfo user, @PathVariable("id") Long albumId, @Valid @RequestBody AlbumUpdateRequest request) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteAlbum(UserInfo user, @PathVariable("id") Long albumId) {
    ...
    public ResponseEntity<Slice<PhotoResponse>> listPhotos(UserInfo user, @PathVariable("id") Long albumId, @ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<PhotoResponse> addPhoto(UserInfo user, @PathVariable("id") Long albumId, @Valid @RequestBody PhotoCreateRequest request) {
    ...
    @PutMapping("/photo/{id}")
    public ResponseEntity<Void> updatePhoto(UserInfo user, @PathVariable("id") Long photoId, @Valid @RequestBody PhotoUpdateRequest request) {
    ...
    public ResponseEntity<Void> deletePhoto(UserInfo user, @PathVariable("id") Long photoId) {
